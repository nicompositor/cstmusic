...
Sitio estático del currículo de Música de Prejardín a Quinto. Incluye agenda diaria según el horario docente, planeador semanal, calendario institucional editable, repertorio editable, navegación por grado, herramientas docentes y un mapa STEAM/transdisciplinar conectado con cada bimestre. No necesita instalación, servidor especial ni proceso de compilación.
...
- Las semanas de receso, jornadas pedagógicas, salidas pedagógicas y evaluación institucional marcadas en el calendario reemplazan automáticamente la clase regular en la vista **Hoy**.
